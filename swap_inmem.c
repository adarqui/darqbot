...
swap_inmem_t *
swap_inmem_create (char *name, int id, void *data_ptr)
{
...
void
swap_inmem_add (swap_inmem_t * swapim)
{
...
swap_inmem_t *
swap_inmem_create_and_add (char *name, int id, void *data_ptr)
{
...
dlist_t *
swap_inmem_get (char *name, int id)
{
  dlist_t *dptr = NULL;
  swap_inmem_t *swapim = NULL;
...
void
swap_inmem_remove (dlist_t ** dptr)
{
  dlist_t *dptr_res;
  if (!dptr)
    return;
...
void
swap_inmem_get_assign_and_remove (char *name, int id, void **data_ptr)
{
  swap_inmem_t *swapim = NULL;
...
void
swap_inmem_console_info (bot_t * bot)
{
  dlist_t *dptr_swapim = NULL;
  swap_inmem_t *swapim = NULL;
  int i = 0;
  ...
  {
    swapim = (swap_inmem_t *) dlist_data (dptr_swapim);
    bot_dl_print (NULL, "swap_inmem: %i. name=%s, id=%i, data_ptr=%p\n", i,
