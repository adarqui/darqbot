...
fd_link_t *
fd_link_add (dlist_t ** dl_fd_link, int fd, struct event ev,
...
fd_link_t *
fd_link_find (dlist_t ** dl_fd_link, int fd)
{
  dlist_t *dptr_bfl;
  fd_link_t *bfl;
...
int
fd_link_del (dlist_t ** dl_fd_link, int fd, void (*cleanup) (fd_link_t *))
{
...
void
fd_link_destroy (dlist_t ** dl_fd_link, void (*cleanup) (fd_link_t *))
{
...
void
fd_link_set_cur (dlist_t ** dl_fd_link, fd_link_t * bfl_arg, int fd)
{
...
char *
fd_link_get_latest_host (bot_t * bot, char *trigger, char *trigger_ext)
{
