...
void
console_info (bot_t * bot, char *arg)
{
  bot_t *bot_ptr;
  int all = 1;
...
void
console_tag_parse (bot_t * bot, char *arg)
{
  char *str;
...
void
bot_evhook_console (int fd, short event, void *arg)
{
...
void
console_parse (bot_t * bot, char *buf)
{
  int bot_set = 0;
  char *tok;
...
/* just dont access these ptr's */
	...
	g_test_mem_2 = g_test_mem_1;
      ...
      bot_dl_print (bot,
		    ...
		    g_test_mem_1 >
		    g_test_mem_2 ? g_test_mem_1 -
		    g_test_mem_2 : g_test_mem_2 - g_test_mem_1, g_test_mem_3,
		    g_test_mem_1 >
	...
	g_test_fd_2 = g_test_fd_1;
      ...
      bot_dl_print (bot,
		    ...
		    g_test_fd_1 >
		    g_test_fd_2 ? g_test_fd_1 - g_test_fd_2 : g_test_fd_2 -
		    g_test_fd_1, g_test_fd_3,
		    g_test_fd_1 >
		    g_test_fd_3 ? g_test_fd_1 - g_test_fd_3 : g_test_fd_3 -
		    g_test_fd_1);
...
void
console_print_all_bot (bot_t * bot, int tab)
{
  dlist_t *dptr = NULL;
