...
bot_t *moby_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *moby_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *moby_help(dlist_t * dlist_node, bot_t * bot)
{
...
int moby_transform_word(char *word1, char *word2)
{
