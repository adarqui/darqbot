...
bot_t *
dumbgames_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
dumbgames_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
dumbgames_help (dlist_t * dlist_node, bot_t * bot)
{
...
int
chamber_compare (const void *a, const void *b)
{
  return rand () % 7;
}

char *
roulette_change_string (int opt)
{
  int d2, i;
  char *str = NULL;
