...
bot_t *
rainbow_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rainbow_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rainbow_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rainbow_run (dlist_t * dlist_node, bot_t * bot)
{
  dlist_t *dl;
...
char *
rainbow_change_string (char *string, int opt, rainbow_colors_t * rc,
		       int rc_index)
{
  int start_color;
  int i;
...
int
rainbow_defaults (rainbow_colors_t * rc, int *rc_index,
		  char *IRC_COLOR_TYPE_STR)
{
