...
bot_t *
uu_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
uu_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
uu_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
uu_run (dlist_t * dlist_node, bot_t * bot)
{
  char *l_str_ptr =
    NULL, *dl_module_arg_after_options, *dl_options_ptr, *l_new_str = NULL;
  int opt;
...
char *
uu_change_string (char *string, int opt, int *new_len)
{
  char *str = NULL;
  char buf[MAX_BUF_SZ];
 ...
 */
int
xxdecode (char *data, int *decoded_len, int *data_offset)
{
  char *bp;
 ...
 */
void
outdec_decode (char *p, int n, char *f, int *cnt)
{
  int c1, c2, c3;
