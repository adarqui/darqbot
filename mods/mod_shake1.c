...
bot_t *shake1_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *shake1_help(dlist_t * dlist_node, bot_t * bot)
{
...
char *shake1_change_string(char *string, int opt)
{
	int i, j, k;
...
void shake1_print_info(bot_t * bot)
{
...
int shake1_fill_toc_info(bot_t * bot, FILE * fp, int *lines, off_t ** offsets)
{
	off_t off;
	off_t *offp, *offp_p;
	char buf[1024];
...
void shake1_fill_toc(bot_t * bot)
{
	char *str;
