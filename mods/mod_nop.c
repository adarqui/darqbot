...
bot_t *
mod_nop_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_nop_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_nop_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_nop_run (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_nop_output (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_nop_input (dlist_t * dlist_node, bot_t * bot)
{
