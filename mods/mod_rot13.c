...
bot_t *rot13_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "rot13_init: Entered\n");
	return NULL;
}

bot_t *rot13_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "rot13_fini: Entered\n");
	return NULL;
}

bot_t *rot13_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *rot13_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *rot13_change_string(char *string, int opt)
{
	int i, c, d;
