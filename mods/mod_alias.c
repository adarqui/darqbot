...
bot_t *alias_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *alias_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *alias_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *alias_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *alias_change_string(dlist_t * dlist_node, bot_t * bot, int opt,
			  char *string)
{
	char *str = NULL;
	...
	if (!str_isclean(tok_1_dup, iskeychars)) {
		debug(bot,
		      "alias_run: Key contains illegal chars, returning\n");
		goto cleanup;
	}
...
char *alias_op_run(dlist_t * dlist_node, bot_t * bot, char *string)
{
	dlist_t *dptr;
...
char *alias_op_get(bot_t * bot, char *string)
{
	char *str = NULL;
...
char *alias_op_del(bot_t * bot, char *string)
{
	char *str = NULL;
...
char *alias_op_add(bot_t * bot, char *string, char *value)
{
	char *str = NULL;
...
char *alias_op_getmore(bot_t * bot, char *string)
{
	char *str = NULL;
