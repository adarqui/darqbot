...
bot_t *cmds_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *cmds_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *cmds_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *cmds_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *cmds_change_string(bot_t * bot, char *string, int opt)
{
	char *str = NULL;
	char buf[MAX_BUF_SZ];
