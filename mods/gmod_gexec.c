...
bot_t *
gexec_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gexec_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gexec_off (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gexec_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gexec_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
gexec_process_options (gexec_t * gexec, char *string)
{
...
void
gexec_process_options_parse (gexec_t * gexec, char *string)
{
...
void
gexec_process_options_parse_bin (gexec_t * gexec, char *string)
{
...
char *
gexec_change_string (bot_t * bot, char *string, int opt)
{
  char *str = NULL;
  char buf[MAX_BUF_SZ];
...
bot_t *
gexec_output (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gexec_t *gexec = NULL;
...
bot_t *
gexec_input (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gexec_t *gexec = NULL;
int n ;
...
bot_t *
gexec_destroy_up_gexec (gexec_t * gexec)
{
  bot_t *ret = NULL;
...
bot_t *
gexec_destroy_down_gexec (gexec_t * gexec)
{
  bot_t *ret = NULL;
...
bot_t *
gexec_destroy_up (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gexec_t *gexec = NULL;
...
bot_t *
gexec_destroy_down (dlist_t * dlist_node, bot_t * bot)
{
...
void
gexec_gmod_init (bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
  gexec_t *gexec = NULL;
...
bot_t *
gexec_control_up (dlist_t * dlist_node, bot_t * bot)
{
  gexec_t *gexec = NULL;
  bot_gmod_elm_t *gmod = NULL;
...
bot_t *
gexec_control_down (dlist_t * dlist_node, bot_t * bot)
{
...
int
gexec_set_evhooks (gexec_t * gexec)
{
...
void
gexec_evhook_link (int fd, short event, void *arg)
{
  gexec_t *gexec = NULL;
  int n;
