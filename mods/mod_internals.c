...
bot_t *internals_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "internals_init: Entered\n");
	return NULL;
}

bot_t *internals_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "internals_fini: Entered\n");
	return NULL;
}

bot_t *internals_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *internals_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *internals_change_string(bot_t * bot, char *string, int opt)
{
