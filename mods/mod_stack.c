...
bot_t *
stack_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
stack_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
stack_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
stack_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
stack_change_string (bot_t * bot, char *string, int opt)
{
  unique_t *bu = NULL;
