...
bot_t *
color_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
color_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
color_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
color_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
color_change_string (char *string, char *color_str, int sub)
{
