...
bot_t *gdaemon_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "gdaemon_init: Entered\n");
	return NULL;
}

bot_t *gdaemon_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "gdaemon_fini: Entered\n");
	return NULL;
}

bot_t *gdaemon_off(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *gdaemon_help(dlist_t * dlist_node, bot_t * bot)
{
...
void gdaemon_process_options_parse(gdaemon_t * gdaemon, char *string)
{
	...
	if (!strncasecmp_len(string, "noclose")) {
		...
		gdaemon->fd_unix_path =
		    strdup(&string[strlen("fd_unix_path=")]);
...
void gdaemon_process_options_parse_mod_names(gdaemon_t * gdaemon, char *string)
{
	dlist_t *dl;
	...
	dl = tokenize(gdaemon->bot, string,
...
char *gdaemon_change_string(bot_t * bot, char *string, int opt)
{
	char *str = NULL;
	char buf[MAX_BUF_SZ];
...
bot_t *gdaemon_output(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gdaemon_t *gdaemon = NULL;
...
bot_t *gdaemon_input(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gdaemon_t *gdaemon = NULL;
...
bot_t *gdaemon_destroy_up_gdaemon(gdaemon_t * gdaemon)
{
	bot_t *ret = NULL;
...
bot_t *gdaemon_destroy_down_gdaemon(gdaemon_t * gdaemon)
{
	bot_t *ret = NULL;
...
bot_t *gdaemon_destroy_up(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gdaemon_t *gdaemon = NULL;
...
bot_t *gdaemon_destroy_down(dlist_t * dlist_node, bot_t * bot)
{
...
void gdaemon_gmod_init(bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
	gdaemon_t *gdaemon = NULL;
...
bot_t *gdaemon_control_up(dlist_t * dlist_node, bot_t * bot)
{
	gdaemon_t *gdaemon = NULL;
	bot_gmod_elm_t *gmod = NULL;
...
bot_t *gdaemon_control_down(dlist_t * dlist_node, bot_t * bot)
{
