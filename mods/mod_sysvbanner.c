...
bot_t *sysvbanner_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "sysvbanner_init: Entered\n");
	return NULL;
}

bot_t *sysvbanner_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "sysvbanner_fini: Entered\n");
	return NULL;
}

bot_t *sysvbanner_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *sysvbanner_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *sysvbanner_change_string(char *string, int opt)
{
