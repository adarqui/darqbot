...
bot_t *
console_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
console_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
console_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
console_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
console_change_string (bot_t * bot, char *string, int opt)
{
  char *str = NULL;
  char *sep_ptr;
