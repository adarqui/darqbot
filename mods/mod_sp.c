...
bot_t *sp_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *sp_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *sp_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *sp_run(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *sp_run_info(bot_t * bot, char *str)
{
	int i;
	if (!bot)
		return NULL;
