...
bot_t *
packmulti_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
packmulti_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
packmulti_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
packmulti_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
packmulti_change_string (bot_t * bot, char *string, int opt)
{
  int i;
