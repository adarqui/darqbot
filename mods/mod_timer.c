...
bot_t *
timer_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
timer_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
timer_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
timer_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
timer_change_string (dlist_t * dlist_node, bot_t * bot, char *string, int opt)
{
  char *str = NULL;
...
bot_t *
timer_timer (dlist_t * dlist_node, bot_t * bot)
{
...
/* timer expired, run cmd */
	...
	bot_copy_values (bot_copy, "TIMER", "TIMER", "TIMER.com", t->chan,
			 t->cmd, t->cmd);
	time (&t->last_run);
...
char *
timer_op_add (bot_t * bot, char *string)
{
  modtimer_t *t;
  dlist_t *dl = NULL;
  char **array = NULL;
...
modtimer_t *
timer_alloc (bot_t * bot, int interval, int count, char *string)
{
  modtimer_t *t;
