...
bot_t *
rant_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rant_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rant_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rant_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
rant_change_string (bot_t * bot, char *string, int opt)
{
  unique_t *bu = NULL;
...
char *
rant_op_clear (bot_t * bot, dlist_t ** dl)
{
...
char *
rant_op_size (bot_t * bot, dlist_t ** dl)
{
  char *str = NULL;
...
char *
rant_op_push (bot_t * bot, dlist_t ** dl, char *string)
{
  unique_t *bu = NULL;
...
char *
rant_op_pop (bot_t * bot, dlist_t ** dl)
{
  unique_t *bu = NULL;
  char *str = NULL;
...
char *
rant_op_list (bot_t * bot, dlist_t ** dl)
{
...
bot_t *
rant_input (dlist_t * dlist_node, bot_t * bot)
{
  unique_t *bu = NULL;
  dlist_t **dl = NULL;
  char *str = NULL;
