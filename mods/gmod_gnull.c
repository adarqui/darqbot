...
bot_t *
gnull_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gnull_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gnull_off (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gnull_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gnull_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
gnull_process_options (gnull_t * gnull, char *string)
{
...
void
gnull_process_options_parse (gnull_t * gnull, char *string)
{
  ...
  if (!strcasecmp (string, "null"))
    {
      gnull_process_options_parse_null (gnull, &string[strlen ("null=")]);
    }
...
void
gnull_process_options_parse_null (gnull_t * gnull, char *string)
{
...
char *
gnull_change_string (bot_t * bot, char *string, int opt)
{
  char *str = NULL;
  char *sep_ptr;
...
bot_t *
gnull_output (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gnull_t *gnull = NULL;
...
bot_t *
gnull_input (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gnull_t *gnull = NULL;
...
bot_t *
gnull_destroy_up_gnull (gnull_t * gnull)
{
  bot_t *ret = NULL;
...
bot_t *
gnull_destroy_down_gnull (gnull_t * gnull)
{
  bot_t *ret = NULL;
...
bot_t *
gnull_destroy_up (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gnull_t *gnull = NULL;
...
bot_t *
gnull_destroy_down (dlist_t * dlist_node, bot_t * bot)
{
...
void
gnull_gmod_init (bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
  gnull_t *gnull = NULL;
...
bot_t *
gnull_control_up (dlist_t * dlist_node, bot_t * bot)
{
  gnull_t *gnull = NULL;
  bot_gmod_elm_t *gmod = NULL;
...
bot_t *
gnull_control_down (dlist_t * dlist_node, bot_t * bot)
{
