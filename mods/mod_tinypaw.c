...
bot_t *
tinypaw_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tinypaw_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tinypaw_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tinypaw_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
tinypaw_change_string (bot_t * bot, char *string, int opt)
{
  ...
  if (curl)
    {
      ...
      curl_easy_setopt (curl, CURLOPT_WRITEFUNCTION, tinypaw_curl_write);
...
size_t
tinypaw_curl_write (void *buf, size_t size, size_t nmemb, void *udata)
{
