...
bot_t *
mod_auto_rejoin_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_auto_rejoin_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_auto_rejoin_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_auto_rejoin_run (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_auto_rejoin_output (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
mod_auto_rejoin_input (dlist_t * dlist_node, bot_t * bot)
{
