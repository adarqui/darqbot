...
bot_t *cmph_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *cmph_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *cmph_help(dlist_t * dlist_node, bot_t * bot)
{
