...
bot_t *string_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "string_init: Entered\n");
	return NULL;
}

bot_t *string_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "string_fini: Entered\n");
	return NULL;
}

bot_t *string_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *string_run(dlist_t * dlist_node, bot_t * bot)
{
	char *tok_opt = NULL;
	...
	case MOD_STRING_STRZERO:
		{
			l_new_str =
			    string_op_strzero(bot, l_str_ptr, opt_str, opt);
			break;
		}
	case MOD_STRING_STRLEN:
		{
			l_new_str =
			    string_op_strlen(bot, l_str_ptr, opt_str, opt);
			break;
		}
	...
	case MOD_STRING_SUBCHAR:
		{
			l_new_str =
			    string_op_subchar(bot, l_str_ptr, opt_str, opt);
			break;
		}
	case MOD_STRING_SPACE:
		{
			l_new_str =
			    string_op_space(bot, l_str_ptr, opt_str, opt);
			break;
		}
	case MOD_STRING_REVERSE:
		{
			l_new_str =
			    string_op_reverse(bot, l_str_ptr, opt_str, opt);
			break;
		}
	case MOD_STRING_UNQUOTE:
		{
			l_new_str =
			    string_op_unquote(bot, l_str_ptr, opt_str, opt);
			break;
		}
	default:
		break;
...
char *string_op_AstrAint(bot_t * bot, char *string, char *opt_str, int opt,
...
char *string_op_AstrAstr(bot_t * bot, char *string, char *opt_str, int opt,
