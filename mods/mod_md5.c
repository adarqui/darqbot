...
bot_t *md5_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "md5_init: Entered\n");
	return NULL;
}

bot_t *md5_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "md5_fini: Entered\n");
	return NULL;
}

bot_t *md5_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *md5_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *md5_change_string(char *string, int opt)
{
	MD5_CTX *m;
	char *str = NULL;
