...
bot_t *
print_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
print_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
print_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
print_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
print_change_string (char *string, int opt, int opt_2, int c_op)
{
  char *str = NULL;
  char *sep_ptr;
...
char *
print_op_binary (int for_or_rev, int c_op, char *string)
{
...
char *
print_op_binary_forward (int c_op, char *string)
{
  char *str = NULL;
...
char *
print_op_binary_forward_char (char *string)
{
  int i, j, res;
  char *str = NULL;
...
char *
print_op_binary_reverse (int c_op, char *string)
{
  char *str = NULL;
...
char *
print_op_binary_reverse_char (char *string)
{
  int i, j, res;
  char *str = NULL;
  char buf[MAX_BUF_SZ + 1];
