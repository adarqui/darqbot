...
bot_t *
rand_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rand_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rand_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
rand_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
rand_change_string (char *string, int opt)
{
  char *sep_ptr;
  char *str = NULL;
