...
bot_t *
quote_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
quote_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
quote_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
quote_run (dlist_t * dlist_node, bot_t * bot)
{
...
void
quote_add_files_to_db_file (char *name)
{
  DB *db = NULL;
  FILE *fp;
  char *name_db;
