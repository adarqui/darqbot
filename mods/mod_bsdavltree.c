...
bot_t *
bsdavltree_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
bsdavltree_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
bsdavltree_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
bsdavltree_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
bsdavltree_change_string (bot_t * bot, char *string, int opt_op, int opt_type)
{
  unique_t *bu = NULL;
  ...
  switch (opt_op)
    ...
    case BSDAVLTREE_OP_POSTORDER:
      {
	str = bsdavltree_op_traverse (bt, string, opt_op, opt_type);
	break;
      }
    default:
      {
...
char *
bsdavltree_op_find (bsdavl_trees_t * bt, char *string, int opt_type)
{
  Tree *tree_ptr = NULL;
  ...
  switch (opt_type)
	...
	v.value = *i;
	vv =
	  (void *) TREE_FIND_COUNT (&x, (Tree *) tree_ptr, bsdavl_node, tree,
				    &v);
	val_int = v.key_int;
	break;
      }
...
char *
bsdavltree_op_depth (bsdavl_trees_t * bt, char *string, int opt_type)
{
  Tree *tree_ptr = NULL;
  char *str = NULL;
...
char *
bsdavltree_op_clear (bsdavl_trees_t * bt, char *string, int opt_type)
{
  Tree *tree_ptr = NULL;
  char *str = NULL;
...
char *
bsdavltree_op_info (bsdavl_trees_t * bt, char *string, int opt_type)
{
  void *tree_ptr = NULL;
  char *str = NULL;
  char buf[MAX_BUF_SZ];
...
char *
bsdavltree_op_traverse (bsdavl_trees_t * bt, char *string, int opt_op,
			int opt_type)
{
  void *tree_ptr = NULL;
  char *str = NULL;
  ...
  switch (opt_op)
    ...
    case BSDAVLTREE_OP_PREORDER:
      {
	TREE_DEPTH_TRAVERSE_PREORDER (x, y, (Tree *) tree_ptr, bsdavl_node,
				      tree, bsdavl_node_depth_fillbuf, buf);
	break;
      }
    case BSDAVLTREE_OP_INORDER:
      {
	TREE_DEPTH_TRAVERSE_INORDER (x, y, (Tree *) tree_ptr, bsdavl_node,
				     tree, bsdavl_node_depth_fillbuf, buf);
	break;
      }
    case BSDAVLTREE_OP_POSTORDER:
      {
	TREE_DEPTH_TRAVERSE_POSTORDER (x, y, (Tree *) tree_ptr, bsdavl_node,
				       tree, bsdavl_node_depth_fillbuf, buf);
	break;
      }
    default:
...
char *
bsdavltree_op_tree (bsdavl_trees_t * bt, char *string, int opt_type)
{
  void *tree_ptr = NULL;
  char *str = NULL;
  char buf[MAX_BUF_SZ];
  ...
  if (bavlt_traverse == BSDAVLTREE_TRAVERSE_REVERSE)
    {
      TREE_DEPTH_REVERSE_APPLY (x, y, (Tree *) tree_ptr, bsdavl_node, tree,
...
char *
bsdavltree_op_add (bsdavl_trees_t * bt, char *string, int opt_type)
{
  ...
  dlist_fornext (dl_toks, dptr_tok)
  {
      ...
      case BSDAVLTREE_TYPE_NUM:
	{
	  ...
	  v.key_int = atoi (tok);
	  v.value = *i;
	  vv = (void *) TREE_FIND ((Tree *) tree_ptr, bsdavl_node, tree, &v);
	  val_int = v.key_int;
	  break;
	}
      case BSDAVLTREE_TYPE_STR:
...
char *
bsdavltree_op_del (bsdavl_trees_t * bt, char *string, int opt_type)
{
  Tree *tree_ptr;
  char *str = NULL;
  char buf[MAX_BUF_SZ];
  ...
  switch (opt_type)
	...
	v.value = *i;
	vv = TREE_FIND ((Tree *) tree_ptr, bsdavl_node, tree, &v);
	val_int = v.key_int;
	break;
      }
    case BSDAVLTREE_TYPE_STR:
...
bsdavl_node_t *
bsdavl_node_new (char *key_str, int key_int, int value)
{
...
int
bsdavl_node_cmp (bsdavl_node_t * left, bsdavl_node_t * right)
{
...
void
bsdavl_node_print (bsdavl_node_t * self, FILE * stream)
{
}


void
bsdavl_node_printer (bsdavl_node_t * self, void *stream)
{
...
void
bsdavl_node_fillbuf (bsdavl_node_t * self, void *buf)
{
...
void
bsdavl_node_depth_fillbuf (bsdavl_node_t * self, int x, int y, void *buf)
{
...
void
bsdavl_node_remove (bsdavl_node_t * self, void *tree_arg)
{
...
Tree *
bsdavl_tree_new (int (*cmp) (bsdavl_node_t * left, bsdavl_node_t * right))
{
  Tree *self = xnew (Tree);
  TREE_INIT (self, cmp);
  return self;
