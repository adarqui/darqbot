...
bot_t *
guile_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
guile_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
guile_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
guile_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
guile_change_string (bot_t * bot, char *string, int opt)
{
  char *str = NULL;
  char buf[MAX_BUF_SZ];
