...
bot_t *gpty_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "gpty_init: Entered\n");
	return NULL;
}

bot_t *gpty_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "gpty_fini: Entered\n");
	return NULL;
}

bot_t *gpty_off(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *gpty_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *gpty_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *gpty_process_options(gpty_t * gpty, char *string)
{
...
void gpty_process_options_parse(gpty_t * gpty, char *string)
{
...
void gpty_process_options_parse_null(gpty_t * gpty, char *string)
{
...
char *gpty_change_string(bot_t * bot, char *string, int opt)
{
	char *str = NULL;
	char *sep_ptr;
...
bot_t *gpty_output(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gpty_t *gpty = NULL;
...
bot_t *gpty_input(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gpty_t *gpty = NULL;
...
bot_t *gpty_destroy_up_gpty(gpty_t * gpty)
{
	bot_t *ret = NULL;
...
bot_t *gpty_destroy_down_gpty(gpty_t * gpty)
{
	bot_t *ret = NULL;
...
bot_t *gpty_destroy_up(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	gpty_t *gpty = NULL;
...
bot_t *gpty_destroy_down(dlist_t * dlist_node, bot_t * bot)
{
...
void gpty_gmod_init(bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
	gpty_t *gpty = NULL;
...
bot_t *gpty_control_up(dlist_t * dlist_node, bot_t * bot)
{
	gpty_t *gpty = NULL;
	bot_gmod_elm_t *gmod = NULL;
...
bot_t *gpty_control_down(dlist_t * dlist_node, bot_t * bot)
{
