...
bot_t *queue_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *queue_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *queue_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *queue_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *queue_change_string(bot_t * bot, char *string, int opt)
{
	unique_t *bu = NULL;
	...
	bu = unique_create(bot, &dl_mod_queue_unique,
