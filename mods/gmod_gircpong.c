...
bot_t *
gircpong_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_off (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_run (dlist_t * dlist_node, bot_t * bot)
{
  ...
  if (!gmod->data)
    {
      debug (NULL, "gircpong_run: GIRCD GMOD->DATA = NULL, ALLOCATING");
...
char *
gircpong_process_options (gircpong_t * gircpong, char *string)
{
  ...
  {
    gircpong_process_options_parse (gircpong, (char *) dlist_data (dptr));
  }
...
void
gircpong_process_options_parse (gircpong_t * gircpong, char *string)
{
...
void
gircpong_process_options_parse_null (gircpong_t * gircpong, char *string)
{
...
char *
gircpong_change_string (bot_t * bot, char *string, int opt)
{
  char *str = NULL;
  char *sep_ptr;
...
bot_t *
gircpong_output (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_input (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
gircpong_destroy_up_gircpong (gircpong_t * gircpong)
{
  bot_t *ret = NULL;
...
bot_t *
gircpong_destroy_down_gircpong (gircpong_t * gircpong)
{
  bot_t *ret = NULL;
...
bot_t *
gircpong_destroy_up (dlist_t * dlist_node, bot_t * bot)
{
  bot_gmod_elm_t *gmod = NULL;
  gircpong_t *gircpong = NULL;
...
bot_t *
gircpong_destroy_down (dlist_t * dlist_node, bot_t * bot)
{
...
void
gircpong_gmod_init (bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
  gircpong_t *gircpong = NULL;
...
bot_t *
gircpong_control_up (dlist_t * dlist_node, bot_t * bot)
{
  gircpong_t *gircpong = NULL;
  bot_gmod_elm_t *gmod = NULL;
...
bot_t *
gircpong_control_down (dlist_t * dlist_node, bot_t * bot)
{
