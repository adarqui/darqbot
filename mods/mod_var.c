...
bot_t *
var_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
var_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
var_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
var_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
var_usleep_fn (bot_t * bot, char *str)
{
  int val;
  if (!bot)
    return NULL;
...
char *
var_multi_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_bufsz_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_maxflood_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_nesting_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_nesting_cur_fn (bot_t * bot, char *str)
{
...
char *
var_allowpm_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_sigprotect_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_timer_sleep_fn (bot_t * bot, char *str)
{
  int val;
...
char *
var_timer_sort_fn (bot_t * bot, char *str)
{
  int val;
