...
bot_t *
tiny_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tiny_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tiny_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
tiny_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
tiny_change_string (bot_t * bot, char *string, int opt)
{
...
size_t
tiny_curl_write (void *buf, size_t size, size_t nmemb, void *udata)
{
