...
bot_t *
char_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
char_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
char_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
char_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
char_change_string (char *string, int opt_rand, int opt_match)
{
  int i, c;
