...
bot_t *grelinkd_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "grelinkd_init: Entered\n");
	return NULL;
}

bot_t *grelinkd_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "grelinkd_fini: Entered\n");
	return NULL;
}

bot_t *grelinkd_off(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkd_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkd_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *grelinkd_process_options(grelinkd_t * grelinkd, char *string)
{
	...
	dlist_fornext(dl, dptr) {
		grelinkd_process_options_parse(grelinkd,
...
char *grelinkd_change_string(bot_t * bot, char *string, int opt)
{
	char *str = NULL;
	char *sep_ptr;
...
bot_t *grelinkd_output(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	grelinkd_t *grelinkd = NULL;
...
bot_t *grelinkd_input(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkd_input_uninitialized(grelinkd_t * grelinkd)
{
	int n;
...
int grelinkd_op_data_notify(grelinkd_t * grelinkd)
{
	int n;
...
int grelinkd_op_data(grelinkd_t * grelinkd, relink_control_pkt_t * rlpkt)
{
...
int grelinkd_op_relink_notify(grelinkd_t * grelinkd)
{
...
/* new link, new connection */
			...
			grelinkd->bot->txt_data_out_sz =
			    relink_res_pack_buf_new(grelinkd->bot->txt_data_out,
						    grelinkd->id);
...
/* old link, reconnect it */
			...
			grelinkd->bot->txt_data_out_sz =
			    relink_res_pack_buf_old(grelinkd->bot->txt_data_out,
						    grelinkd->id);
			relink_packet_hton((relink_control_pkt_t *)
					   grelinkd->bot->txt_data_out);
			break;
...
int grelinkd_op_relink(grelinkd_t * grelinkd, relink_control_pkt_t * rlpkt)
{
...
bot_t *grelinkd_destroy_up_grelinkd(grelinkd_t * grelinkd)
{
	bot_t *ret = NULL;
...
bot_t *grelinkd_destroy_down_grelinkd(grelinkd_t * grelinkd)
{
	bot_t *ret = NULL;
...
bot_t *grelinkd_destroy_up(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	grelinkd_t *grelinkd = NULL;
...
bot_t *grelinkd_destroy_down(dlist_t * dlist_node, bot_t * bot)
{
...
void grelinkd_gmod_init(bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
	grelinkd_t *grelinkd = NULL;
...
bot_t *grelinkd_control_up(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkd_control_down(dlist_t * dlist_node, bot_t * bot)
{
...
dlist_t *grelinkd_find_id(grelinkd_t * grelinkd, bot_t ** bot)
{
...
void grelinkd_combine_dlist(grelinkd_t * grelinkd, grelinkd_t * grelinkd_saved)
{
	...
	dlist_forprev_retarded(dlist_tail(grelinkd_saved->bot->dl_gmodules),
		...
		dlist_insert_after(&grelinkd->bot->dl_gmodules,
				   grelinkd->dptr_gmod, dptr_gmod_removed);
	}
