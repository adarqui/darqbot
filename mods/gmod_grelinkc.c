...
bot_t *grelinkc_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "grelinkc_init: Entered\n");
	return NULL;
}

bot_t *grelinkc_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "grelinkc_fini: Entered\n");
	return NULL;
}

bot_t *grelinkc_off(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkc_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *grelinkc_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *grelinkc_process_options(grelinkc_t * grelinkc, char *string)
{
	...
	dlist_fornext(dl, dptr) {
		grelinkc_process_options_parse(grelinkc,
...
void grelinkc_process_options_parse(grelinkc_t * grelinkc, char *string)
{
	...
	if (!strncasecmp_len(string, "id")) {
		grelinkc_process_options_parse_id(grelinkc,
						  &string[strlen("id=")]);
...
char *grelinkc_change_string(bot_t * bot, char *string, int opt)
{
	char *str = NULL;
	char buf[MAX_BUF_SZ];
...
bot_t *grelinkc_output(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	grelinkc_t *grelinkc = NULL;
...
bot_t *grelinkc_input(dlist_t * dlist_node, bot_t * bot)
{
...
int grelinkc_op_hello(grelinkc_t * grelinkc, relink_control_pkt_t * rlpkt)
{
	...
	n = relink_req_pack_buf_relink_new(grelinkc->bot->txt_data_out,
...
int grelinkc_op_data_notify(grelinkc_t * grelinkc)
{
	int n;
...
int grelinkc_op_data(grelinkc_t * grelinkc, relink_control_pkt_t * rlpkt)
{
	int n = 0;
	char *data_ptr;
	int data_len;
...
int grelinkc_op_result(grelinkc_t * grelinkc, relink_control_pkt_t * rlpkt)
{
	int n = 0;
...
bot_t *grelinkc_destroy_up_grelinkc(grelinkc_t * grelinkc)
{
	bot_t *ret = NULL;
...
bot_t *grelinkc_destroy_down_grelinkc(grelinkc_t * grelinkc)
{
	bot_t *ret = NULL;
...
bot_t *grelinkc_destroy_up(dlist_t * dlist_node, bot_t * bot)
{
	bot_gmod_elm_t *gmod = NULL;
	grelinkc_t *grelinkc = NULL;
...
bot_t *grelinkc_destroy_down(dlist_t * dlist_node, bot_t * bot)
{
...
void grelinkc_gmod_init(bot_t * bot, bot_gmod_elm_t * gmod, dlist_t * dptr_gmod)
{
	grelinkc_t *grelinkc = NULL;
...
bot_t *grelinkc_control_up(dlist_t * dlist_node, bot_t * bot)
{
	grelinkc_t *grelinkc = NULL;
	bot_gmod_elm_t *gmod = NULL;
...
bot_t *grelinkc_control_down(dlist_t * dlist_node, bot_t * bot)
{
