...
bot_t *bin_init(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *bin_fini(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *bin_help(dlist_t * dlist_node, bot_t * bot)
{
...
char *bin_change_string(bot_t * bot, char *prog, char *options, char *input,
			dlist_t * dlist_node)
{
	char *str = NULL;
	char *sep_ptr;
