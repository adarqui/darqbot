...
bot_t *
festival_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
festival_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
festival_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
festival_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
festival_change_string (char *string, int opt)
{
  char *str = NULL;
  char buf[MAX_BUF_SZ];
...
int
festival_send (bot_t * bot, char *msg, int len)
{
  int fd, n;
  if (!bot || !msg || len <= 0)
    return len;
