...
bot_t *
emot_init (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
emot_fini (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
emot_help (dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *
emot_run (dlist_t * dlist_node, bot_t * bot)
{
...
char *
emot_change_string (char *string, int opt_1, char *opt_3)
{
  int d;
...
int
emot_rand_compare (const void *v1, const void *v2)
{
  int vals[3], r;
