...
bot_t *caps_init(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "caps_init: Entered\n");
	return NULL;
}

bot_t *caps_fini(dlist_t * dlist_node, bot_t * bot)
{
	debug(bot, "caps_fini: Entered\n");
	return NULL;
}

bot_t *caps_help(dlist_t * dlist_node, bot_t * bot)
{
...
bot_t *caps_run(dlist_t * dlist_node, bot_t * bot)
{
...
char *caps_change_string(char *string, int opt)
{
