...
int bit_extract_bit_char(unsigned char byte, int pos)
{
	if (pos < 0)
		return 0;
...
int bit_pack_bit_char(unsigned char *byte, int pos, int val)
{
	int b;
...
int bit_pack_bit_char_set(unsigned char *byte, int pos)
{
	return bit_pack_bit_char(byte, pos, 1);
}

int bit_pack_bit_char_clr(unsigned char *byte, int pos)
{
	return bit_pack_bit_char(byte, pos, 0);
}

bit_vector_t *bit_vec_init(int size)
{
	bit_vector_t *bv;
	if (size <= 0)
		return NULL;
...
void bit_vec_fini(bit_vector_t ** arg)
{
...
int bit_vec_get_and_set(bit_vector_t * bv)
{
	int bit;
...
void bit_vec_clr(bit_vector_t * bv, int pos)
{
	int vec_pos, vec_mod;
	unsigned char byte;
	int found;
...
void bit_vec_set(bit_vector_t * bv, int pos)
{
...
int bit_vec_get(bit_vector_t * bv, int pos)
{
...
int bit_vec_scan(bit_vector_t * bv, int val)
{
	int bit, byte, i, j, k;
...
void bit_vec_from_str(bit_vector_t * bv, char *string)
{
...
void bit_vec_from_num(bit_vector_t * bv, unsigned long num)
{
...
void bit_vec_and(bit_vector_t * bv1, bit_vector_t * bv2, bit_vector_t * bvres)
{
	int i, bit_1, bit_2;
...
void bit_vec_or(bit_vector_t * bv1, bit_vector_t * bv2, bit_vector_t * bvres)
{
	int i, bit_1, bit_2;
...
void bit_vec_xor(bit_vector_t * bv1, bit_vector_t * bv2, bit_vector_t * bvres)
{
	int i, bit_1, bit_2;
...
void bit_vec_not(bit_vector_t * bv)
{
	int i, bit;
...
int bit_vec_3safe(bit_vector_t * bv1, bit_vector_t * bv2, bit_vector_t * bvres)
{
/* returns 0 if unsafe */
	int max_sz;
