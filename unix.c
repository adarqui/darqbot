...
/* man psignal , man strsignal */
  ...
  else if (!strcasecmp (string, "SIGQUIT") || !strcasecmp (string, "QUIT"))
    {
      signum = SIGQUIT;
    }
  ...
  else if (!strcasecmp (string, "SIGTRAP") || !strcasecmp (string, "TRAP"))
    {
      signum = SIGTRAP;
    }
  else if (!strcasecmp (string, "SIGABRT") || !strcasecmp (string, "ABRT"))
    {
      signum = SIGABRT;
    }
  ...
  else if (!strcasecmp (string, "SIGUSR1") || !strcasecmp (string, "USR1"))
    {
      signum = SIGUSR1;
    }
  else if (!strcasecmp (string, "SIGALRM") || !strcasecmp (string, "ALRM"))
    {
      signum = SIGALRM;
    }
  else if (!strcasecmp (string, "SIGUSR2") || !strcasecmp (string, "USR2"))
    {
      signum = SIGUSR2;
    }
  else if (!strcasecmp (string, "SIGPIPE") || !strcasecmp (string, "PIPE"))
    {
      signum = SIGPIPE;
    }
  else if (!strcasecmp (string, "SIGTERM") || !strcasecmp (string, "TERM"))
    {
      signum = SIGTERM;
    }
  ...
  else if (!strcasecmp (string, "SIGCHLD") || !strcasecmp (string, "CHLD"))
    {
      signum = SIGCHLD;
    }
  else if (!strcasecmp (string, "SIGCONT") || !strcasecmp (string, "CONT"))
    {
      signum = SIGCONT;
    }
  else if (!strcasecmp (string, "SIGSTOP") || !strcasecmp (string, "STOP"))
    {
      signum = SIGSTOP;
    }
  else if (!strcasecmp (string, "SIGTSTP") || !strcasecmp (string, "TSTP"))
    {
      signum = SIGTSTP;
    }
  else if (!strcasecmp (string, "SIGTTIN") || !strcasecmp (string, "TTIN"))
    {
      signum = SIGTTIN;
    }
  else if (!strcasecmp (string, "SIGTTOU") || !strcasecmp (string, "TTOU"))
    {
      signum = SIGTTOU;
    }
  ...
  else if (!strcasecmp (string, "SIGXCPU") || !strcasecmp (string, "XCPU"))
    {
      signum = SIGXCPU;
    }
  else if (!strcasecmp (string, "SIGXFSZ") || !strcasecmp (string, "XFSZ"))
    {
      signum = SIGXFSZ;
    }
  ...
  else if (!strcasecmp (string, "SIGPROF") || !strcasecmp (string, "PROF"))
    {
      signum = SIGPROF;
    }
  else if (!strcasecmp (string, "SIGWINCH") || !strcasecmp (string, "WINCH"))
    {
      signum = SIGWINCH;
    }
  else if (!strcasecmp (string, "SIGPOLL") || !strcasecmp (string, "POLL"))
    {
      signum = SIGPOLL;
    }
...
sig_itos (int signum)
{
  ...
  switch (signum)
    ...
    case SIGWINCH:
      ...
      break;
    case SIGIO:
      str = "Pollable event occurred (System V). I/O now possible (4.2 BSD).";
      break;
    case SIGPWR:
...
int
close_io_descriptors (char *to_dup)
{
  int fd;
