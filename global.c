...
int global_parse_chroot(char *str, int add)
{
	char *ptr_1;
...
int global_parse_modules(char *str, int add)
{
...
int global_parse_pmodules(char *str, int add)
{
...
int global_parse_gmodules(char *str, int add)
{
...
int global_parse_trace(char *str, int add)
{
	char *ptr_1;
...
int global_parse_debug(char *str, int add)
{
	char *ptr_1;
...
int global_parse_sigprotect(char *str, int add)
{
	char *ptr_1;
...
int global_parse_timer_sleep(char *str, int add)
{
	char *ptr_1;
...
int global_parse_timer_sort(char *str, int add)
{
	char *ptr_1;
...
int global_parse_fd_unix_path(char *str, int add)
{
	char *ptr_1;
...
void global_set_proc_ptrs(int *argc, char **argv, char **env)
{
	gi->argv = argv;
	gi->argc = argc;
	gi->env = env;
...
void global_gcmd_add(void (*fn) (void *), void *data)
{
	gi->gcmd = fn;
}
...
void global_getopt(int argc, char **argv)
{
	int opt;
