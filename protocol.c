...
dlist_t *chan_find(bot_t * bot, char *name)
{
	dlist_t *dptr;
	int found = 0;
...
dlist_t *chan_del_user(bot_t * bot, dlist_t * dl, char *name)
{
	dlist_t *dptr;
	char *user;
...
dlist_t *chan_find_user(bot_t * bot, dlist_t * dl, char *name)
{
	dlist_t *dptr = NULL;
	char *user;
...
dlist_t *chan_add_user(bot_t * bot, dlist_t * dl, char *name)
{
